...
"Constructor Self:"# self es obligatorio como primer parámetro en los métodos dentro de clases (excepto los métodos @staticmethod).
...
"Funcion is numeric:"# funcion .isnumeric() devuelve un booleano verificando una variable cualesquiera
# es decir si quiero verificar num = 9, num.isnumeric() devolvera True

"Logica para la creacion del Objeto(Alumno)"#Osea la secuencia si quiero guardar un alumno nuevo: Tengo dos clases, una de ellas
...
"Metodo str"#El metodo string se utiliza para despues poder invocar los atributos del objeto facilmente. Es decir si quisiera imprimir por pantalla los atributos de un objeto "x"
